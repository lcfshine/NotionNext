...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'lcfshine', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '给理想留点时间，熬过低估繁华自现', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lcfshine.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '廖诚富, lcfshine,风微凉', // 网站关键词 英文逗号隔开
